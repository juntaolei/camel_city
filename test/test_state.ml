...
let mine = 
  new_building "mine" 100 5 ("iron", 5) 6 7 [] 2 0 false
...
let expected_cell_array_1_1 =
  ...
  empty.(6).(0) <-
    Building (new_building "house" 50 0 ("", 0) 10 1 [] 0 5 false);
  empty.(6).(1) <-
    Building (new_building "oats_plantation" 10 5 ("food", 5) 6 7 [] 0 0 false);
  empty.(7).(0) <-
    Building (new_building "house" 50 0 ("", 0) 10 1 [] 0 5 false);
  empty.(7).(1) <-
    Building
...
(** [expected_stockpile_2] is the stockpile of state_1 after placing a new 
    oat plantation. *)
...
let state_test =
  [
    ...
    stockpile_test "stockpile of state_1_1" state_1_1 expected_stockpile_1;
    cell_test "cell test for state_1_1" state_1_1 expected_cell_array_1_1;
    ...
    stockpile_test "stockpile of state_1_2" state_1_2 expected_stockpile_1;
    cell_test "cell test for state_1_2" state_1_2 expected_cell_array_1_2;
